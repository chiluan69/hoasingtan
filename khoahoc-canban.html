...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><img src="img/logo-hst.png" style="width: 100px;"></img></h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="daotao.html" class="nav-item nav-link active">Đào tạo</a>
    ...
    <!-- Navbar End -->
   <!-- Background Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header-1">
    ...
    <!-- thông tin khóa học -->
    <h1 class="thongtin" style="color: #000;" >KHÓA HỌC - BÁN HÀNG CĂN BẢN</h1>
    <a class="" style="color: #000 ;" >Khái niệm quy trình bán hàng là gì?<br>
        ...
        Quy trình bán hàng bao gồm các bước nào?
        ...
        Sơ đồ quy trình bán hàng chung
